...
// Path: welcome
class _TranslationsWelcomePt implements TranslationsWelcomeEn {
...
// Path: register
class _TranslationsRegisterPt implements TranslationsRegisterEn {
...
// Path: swipe_cards
class _TranslationsSwipeCardsPt implements TranslationsSwipeCardsEn {
	...
	@override String get nope => 'Não para {{title}}';
	@override String get joined_event => 'Você se juntou ao evento {{title}}';
	@override String get item_changed => 'Item modificado: {{title}}';
}

// Path: event
class _TranslationsEventPt implements TranslationsEventEn {
	...
	@override String get hasJoinEvent => 'Você se juntou ao evento {{event_title}}';
...
// Path: error
class _TranslationsErrorPt implements TranslationsErrorEn {
	_TranslationsErrorPt._(this._root);

	final TranslationsPt _root; // ignore: unused_field

	// Translations
	@override String get details => 'Erro: {{error}}';
...
// Path: verify
class _TranslationsVerifyPt implements TranslationsVerifyEn {
...
// Path: resources
class _TranslationsResourcesPt implements TranslationsResourcesEn {
...
// Path: page
class _TranslationsPagePt implements TranslationsPageEn {
...
extension on TranslationsPt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'swipe_cards.nope': return 'Não para {{title}}';
			case 'swipe_cards.joined_event': return 'Você se juntou ao evento {{title}}';
			case 'swipe_cards.item_changed': return 'Item modificado: {{title}}';
			case 'event.online': return 'Online';
			case 'event.physical': return 'Presencial';
			case 'event.participants': return 'Participantes';
			case 'event.hasJoinEvent': return 'Você se juntou ao evento {{event_title}}';
			...
			case 'error.details': return 'Erro: {{error}}';
