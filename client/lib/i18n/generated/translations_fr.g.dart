...
class TranslationsFormFr {
	...
	String get shortPassword => 'Le mot de passe doit comporter au moins 8 caractères';
	String get passwordUpperCase => 'Le mot de passe doit comporter au moins une lettre majuscule';
	String get passwordDigit => 'Le mot de passe doit comporter au moins un chiffre';
	String get passwordSpecialChar => 'Le mot de passe doit comporter au moins un caractère spécial';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'form.shortPassword': return 'Le mot de passe doit comporter au moins 8 caractères';
			case 'form.passwordUpperCase': return 'Le mot de passe doit comporter au moins une lettre majuscule';
			case 'form.passwordDigit': return 'Le mot de passe doit comporter au moins un chiffre';
			case 'form.passwordSpecialChar': return 'Le mot de passe doit comporter au moins un caractère spécial';
