...
class _TranslationsSwipeCardsSv implements TranslationsSwipeCardsFr {
	...
	@override String joined_event({required Object title}) => 'Du har gått med i evenemanget ${title}';
...
extension on TranslationsSv {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'swipe_cards.joined_event': return ({required Object title}) => 'Du har gått med i evenemanget ${title}';
