...
// Path: app
class _TranslationsAppEs implements TranslationsAppFr {
	...
	@override String get offlineVerifyConnection => 'Verifique su conexión a Internet';
	@override String get reconnect => 'Conexión restablecida';
	@override String get friendlist => 'Lista de amigos';
	@override String get friends => 'Amigos';
	@override String get conversations => 'Conversaciones';
	@override String get eventspending => 'Eventos pendientes';
	@override String get eventsincoming => 'Eventos próximos';
	@override String get eventspast => 'Eventos pasados';
	@override String get list => 'Lista';
	@override String get map => 'Mapa';
}

// Path: user
class _TranslationsUserEs implements TranslationsUserFr {
	...
	@override String get noBio => 'Bio no disponible';
	@override String get noBirthdate => 'Fecha de nacimiento no disponible';
	@override String get noLocation => 'Lugar no disponible';
	@override String get noEmail => 'Correo electrónico no disponible';
	@override String get noUsername => 'Nombre de usuario no disponible';
	@override String get noName => 'Nombre no disponible';
	@override String get noFirstname => 'Nombre no disponible';
...
// Path: register
class _TranslationsRegisterEs implements TranslationsRegisterFr {
...
// Path: form
class _TranslationsFormEs implements TranslationsFormFr {
...
// Path: swipe_cards
class _TranslationsSwipeCardsEs implements TranslationsSwipeCardsFr {
...
// Path: event
class _TranslationsEventEs implements TranslationsEventFr {
...
// Path: error
class _TranslationsErrorEs implements TranslationsErrorFr {
	...
	@override String get no_results => 'Ningún resultado encontrado';
...
// Path: auth
class _TranslationsAuthEs implements TranslationsAuthFr {
...
// Path: verify
class _TranslationsVerifyEs implements TranslationsVerifyFr {
...
// Path: profile
class _TranslationsProfileEs implements TranslationsProfileFr {
...
// Path: resources
class _TranslationsResourcesEs implements TranslationsResourcesFr {
...
// Path: messages
class _TranslationsMessagesEs implements TranslationsMessagesFr {
...
// Path: common
class _TranslationsCommonEs implements TranslationsCommonFr {
...
// Path: settings
class _TranslationsSettingsEs implements TranslationsSettingsFr {
	...
	@override String get manageSubjects => 'Gestión de materias';
...
// Path: page
class _TranslationsPageEs implements TranslationsPageFr {
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'app.unknown': return 'Desconocido';
			case 'app.favoriteDocuments': return 'Documentos Favoritos';
			case 'app.offlineVerifyConnection': return 'Verifique su conexión a Internet';
			case 'app.reconnect': return 'Conexión restablecida';
			case 'app.friendlist': return 'Lista de amigos';
			case 'app.friends': return 'Amigos';
			case 'app.conversations': return 'Conversaciones';
			case 'app.eventspending': return 'Eventos pendientes';
			case 'app.eventsincoming': return 'Eventos próximos';
			case 'app.eventspast': return 'Eventos pasados';
			...
			case 'user.noBio': return 'Bio no disponible';
			case 'user.noBirthdate': return 'Fecha de nacimiento no disponible';
			case 'user.noLocation': return 'Lugar no disponible';
			case 'user.noEmail': return 'Correo electrónico no disponible';
			case 'user.noUsername': return 'Nombre de usuario no disponible';
			case 'user.noName': return 'Nombre no disponible';
			case 'user.noFirstname': return 'Nombre no disponible';
			case 'user.you': return 'tú';
			case 'user.me': return '(yo)';
			...
			case 'error.no_results': return 'Ningún resultado encontrado';
			...
			case 'settings.account': return 'Cuenta';
			case 'settings.settings': return 'Ajustes';
			case 'settings.language': return 'Idioma';
			case 'settings.manageSubjects': return 'Gestión de materias';
			case 'settings.notifications': return 'Notificaciones';
			case 'settings.about': return 'Acerca de';
			case 'settings.contact': return 'Contacto';
			case 'settings.terms': return 'Términos de uso';
			case 'settings.privacy': return 'Política de privacidad';
