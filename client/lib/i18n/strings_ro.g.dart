...
// Path: app
class _TranslationsAppRo implements TranslationsAppEn {
...
// Path: user
class _TranslationsUserRo implements TranslationsUserEn {
...
// Path: welcome
class _TranslationsWelcomeRo implements TranslationsWelcomeEn {
...
// Path: register
class _TranslationsRegisterRo implements TranslationsRegisterEn {
...
// Path: swipe_cards
class _TranslationsSwipeCardsRo implements TranslationsSwipeCardsEn {
	...
	@override String get nope => 'Nu pentru {{title}}';
	@override String get joined_event => 'Te-ai alăturat evenimentului {{title}}';
	@override String get item_changed => 'Element modificat: {{title}}';
}

// Path: event
class _TranslationsEventRo implements TranslationsEventEn {
	...
	@override String get hasJoinEvent => 'Te-ai alăturat evenimentului {{event_title}}';
...
// Path: error
class _TranslationsErrorRo implements TranslationsErrorEn {
	_TranslationsErrorRo._(this._root);

	final TranslationsRo _root; // ignore: unused_field

	// Translations
	@override String get details => 'Eroare: {{error}}';
...
// Path: auth
class _TranslationsAuthRo implements TranslationsAuthEn {
...
// Path: verify
class _TranslationsVerifyRo implements TranslationsVerifyEn {
...
// Path: resources
class _TranslationsResourcesRo implements TranslationsResourcesEn {
...
// Path: messages
class _TranslationsMessagesRo implements TranslationsMessagesEn {
...
// Path: page
class _TranslationsPageRo implements TranslationsPageEn {
...
extension on TranslationsRo {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'swipe_cards.joined_event': return 'Te-ai alăturat evenimentului {{title}}';
			case 'swipe_cards.item_changed': return 'Element modificat: {{title}}';
			case 'event.online': return 'Online';
			case 'event.physical': return 'Fizic';
			case 'event.participants': return 'Participanți';
			case 'event.hasJoinEvent': return 'Te-ai alăturat evenimentului {{event_title}}';
			...
			case 'error.details': return 'Eroare: {{error}}';
