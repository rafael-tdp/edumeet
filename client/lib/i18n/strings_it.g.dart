...
// Path: user
class _TranslationsUserIt implements TranslationsUserEn {
	...
	@override String get noBio => 'Bio non disponibile';
	@override String get noBirthdate => 'Data di nascita non disponibile';
	@override String get noLocation => 'Luogo non disponibile';
	@override String get noEmail => 'Email non disponibile';
	@override String get noUsername => 'Nome utente non disponibile';
	@override String get noName => 'Nome non disponibile';
	@override String get noFirstname => 'Nome non disponibile';
	@override String get you => 'tu';
	@override String get me => '(me)';
}

// Path: welcome
class _TranslationsWelcomeIt implements TranslationsWelcomeEn {
...
// Path: register
class _TranslationsRegisterIt implements TranslationsRegisterEn {
...
// Path: swipe_cards
class _TranslationsSwipeCardsIt implements TranslationsSwipeCardsEn {
	...
	@override String get joined_event => 'Hai partecipato all\'evento {{title}}';
	@override String get item_changed => 'Elemento modificato: {{title}}';
}

// Path: event
class _TranslationsEventIt implements TranslationsEventEn {
	...
	@override String get hasJoinEvent => 'Hai partecipato all\'evento {{event_title}}';
...
// Path: error
class _TranslationsErrorIt implements TranslationsErrorEn {
	_TranslationsErrorIt._(this._root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get details => 'Errore: {{error}}';
...
// Path: verify
class _TranslationsVerifyIt implements TranslationsVerifyEn {
...
// Path: resources
class _TranslationsResourcesIt implements TranslationsResourcesEn {
...
// Path: page
class _TranslationsPageIt implements TranslationsPageEn {
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'user.noBio': return 'Bio non disponibile';
			case 'user.noBirthdate': return 'Data di nascita non disponibile';
			case 'user.noLocation': return 'Luogo non disponibile';
			case 'user.noEmail': return 'Email non disponibile';
			case 'user.noUsername': return 'Nome utente non disponibile';
			case 'user.noName': return 'Nome non disponibile';
			case 'user.noFirstname': return 'Nome non disponibile';
			...
			case 'swipe_cards.joined_event': return 'Hai partecipato all\'evento {{title}}';
			case 'swipe_cards.item_changed': return 'Elemento modificato: {{title}}';
			case 'event.online': return 'Online';
			case 'event.physical': return 'Fisico';
			case 'event.participants': return 'Partecipanti';
			case 'event.hasJoinEvent': return 'Hai partecipato all\'evento {{event_title}}';
			...
			case 'error.details': return 'Errore: {{error}}';
