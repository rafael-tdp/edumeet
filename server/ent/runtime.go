...
func init() {
	...
	badgeDescCreatedAt := badgeFields[0].Descriptor()
	...
	badgeDescUpdatedAt := badgeFields[1].Descriptor()
	...
	badgeDescID := badgeFields[4].Descriptor()
	...
	eventDescIsPrivate := eventFields[8].Descriptor()
	...
	eventDescID := eventFields[4].Descriptor()
	...
	subjectDescCreatedAt := subjectFields[0].Descriptor()
	...
	subjectDescUpdatedAt := subjectFields[1].Descriptor()
	...
	subjectDescName := subjectFields[5].Descriptor()
	...
	subjectDescID := subjectFields[4].Descriptor()
	...
	userDescActivated := userFields[13].Descriptor()
	...
	userDescReportNumber := userFields[14].Descriptor()
