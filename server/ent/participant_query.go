...
func (pq *ParticipantQuery) FirstIDX(ctx context.Context) string {
...
func (pq *ParticipantQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (pq *ParticipantQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(participant.Table, participant.Columns, sqlgraph.NewFieldSpec(participant.FieldID, field.TypeString))
	_spec.From = pq.sql
